...
import { Upload, Film, X, FileVideo, Flame, ShieldAlert, Link } from 'lucide-react';
...
export const SAMPLE_VIDEOS = [
  ...
  },
  {
    ...
    suggestedContext: 'Outdoor parking or bike rack surveillance camera',
    suggestedTargets: 'Bike theft, stealing bicycle, cutting lock, unauthorized removal',
  },
  {
    id: 'stealing2',
    name: 'Bike Theft #2',
    url: 'https://82qj2yqd8lzq6kc0.public.blob.vercel-storage.com/Stealing012_x264.mp4',
    size: '16 MB',
    icon: ShieldAlert,
    color: 'text-yellow-400',
    bgColor: 'bg-yellow-500/20',
    suggestedContext: 'Outdoor parking or bike rack surveillance camera',
    suggestedTargets: 'Bike theft, stealing bicycle, suspicious behavior near bikes',
  },
  {
    id: 'fire',
    name: 'Fire Incident',
