...
export const SAMPLE_VIDEOS = [
  ...
  },
  {
    ...
    suggestedContext: 'Retail store surveillance camera',
    suggestedTargets: 'Shoplifting, theft, concealing merchandise',
  },
  {
    id: 'stealing2',
    name: 'Shoplifting #2',
    ...
    suggestedContext: 'Retail store surveillance camera',
    suggestedTargets: 'Shoplifting, theft, suspicious behavior',
  },
  {
    id: 'fire',
    name: 'Fire Incident',
